        ...
        for (final it in items) {
          if (it is Map<String, dynamic>) {
            ...
            if (it.containsKey('item_basic_info') && it['item_basic_info'] is Map) {
              ...
              final link = (it['publish_info'] is Map && it['publish_info']['click_url'] != null)
                  ? it['publish_info']['click_url'].toString()
                  : (it['click_url'] ?? it['clickUrl'] ?? it['purl'] ?? '').toString();
        ...
        if (mlist != null) {
          for (final it in mlist) {
            if (it is Map<String, dynamic>) {
              ...
              final link = (it['click_url'] ?? it['coupon_click_url'] ?? it['purl'] ?? it['clickUrl'] ?? '').toString();
